...
public class CloverOrder {
  ...
  private CloverOrder(Clover instance, String account, String title, String amount, String permissions, String type, String clientOrderId, String imageUrl) {
  ...
  public static class Builder {
     ...
     */
    public CloverOrder build() {
      return new CloverOrder(instance, account, title, amount,
